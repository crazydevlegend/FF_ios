...
open class CropViewController: UIViewController {
    ...
    open override func viewDidLoad() {
        ...
        navigationController?.toolbar.tintColor = UIColor(hexString: colors.ThemeSky)
        navigationController?.navigationBar.tintColor = UIColor(hexString: colors.ThemeSky)
        ...
        if self.toolbarItems == nil {
            ...
            let constrainButton = UIBarButtonItem(title: "Resize", style: .plain, target: self, action: #selector(CropViewController.constrain(_:)))
