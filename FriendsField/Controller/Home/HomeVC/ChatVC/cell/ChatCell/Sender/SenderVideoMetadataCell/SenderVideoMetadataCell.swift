...
import UIKit
import AVKit
class SenderVideoMetadataCell: UITableViewCell,AVPlayerViewControllerDelegate  {
...
//    @IBOutlet var msgLbl: UITextView!
...
extension SenderVideoMetadataCell : UITableViewDelegate,UITableViewDataSource{
