...
internal struct DPDConstant {
	...
	internal struct UI {
        ...
        static let TextFont = UIFont.Roboto(size: (UIDevice.current.userInterfaceIdiom == .pad) ? 20.0 : 16.0, weight: .Medium)
        static let BackgroundColor = UIColor.init(hexString: colors.ThemeGray)//UIColor(white: 0.94, alpha: 1)
